			...
			<table width='100%' cellspacing='0' cellpadding='0'>
				...
				if($_POST['edit']==$row['id']){?>
					<tr onmouseover="$(this).css('background','#efffd0')" onmouseout="$(this).css('background','#fff')">
						...
						<td class='tdhead2'><input type='text' class='settings req2' name='name' id='name2' value='<?=$row['name']?>' style='width:60px; margin-left:0px;'/></td>
						...
						<td class='tdhead2' align='right' style='border-right:1px solid #e6e6e6;'><a href='#' onclick="return edit2tax(<?=$row['id']?>)"><img src='style/images/tick.png' height='30'/></a><a href='#' onclick="return edittax('0')"><img src='style/images/cancel.png' height='30'/></a></td>
					</tr>
				<?}else{
						?>
					<tr onmouseover="$(this).css('background','#efffd0')" onmouseout="$(this).css('background','#fff')">
