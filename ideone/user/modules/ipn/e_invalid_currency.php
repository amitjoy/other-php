<?php
// ------------------------------------------------------------
// INCORRECT CURRENCY TYPE FOR REGULAR SUBSCRIPTION
...
<body>
  	<p>Hello Admin,</p>
	<p>This is an automated e-mail to let you know that there was a problem with a PayPal transaction for your premium subscription site. Some one was paying for a Subscription but the <strong>Currency Type</strong> does NOT match the value in the database.</p>
	...
	<p>
		...
		<span style="font-weight:bold;color:Red">Currency: '.$payment_currency.'</span><br/>
